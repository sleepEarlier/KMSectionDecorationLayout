#
#  Be sure to run `pod spec lint KMSectionDecorationLayout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "KMSectionDecorationLayout"
  s.version      = "0.2.0"
  s.summary      = "A layout that has decoration view for each section."
...
s.ios.deployment_target = "7.0"
  ...
  s.source       = { :git => "https://github.com/sleepEarlier/KMSectionDecorationLayout.git",   :tag => s.version}
  ...
  s.source_files  = "KMSectionDecorationLayout/KMSectionDecorationLayout/*.{h,m}"
